    ...
    if (index < self.mediaAssetArray.count ) {
        ...
        if (asset.imageClear) {
            ...
            if ([asset.remoteMediaURL isKindOfClass:[NSURL class]]) {
                [self.mediumImageView sd_setImageWithPreviousCachedImageWithURL:asset.remoteMediaURL placeholderImage:nil options:SDWebImageRetryFailed progress:^(NSInteger receivedSize, NSInteger expectedSize, NSURL * _Nullable targetURL) {
                    /*
