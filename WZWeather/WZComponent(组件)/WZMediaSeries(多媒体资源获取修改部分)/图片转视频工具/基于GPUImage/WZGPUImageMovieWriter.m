...
///片元着色器
NSString *const WZkGPUImageColorSwizzlingFragmentShaderString = SHADER_STRING
(
...
#warning 修改处
    ...
    runSynchronouslyOnContextQueue(_movieWriterContext, ^{
        ...
        {
            colorSwizzlingProgram = [_movieWriterContext programForVertexShaderString:kGPUImageVertexShaderString fragmentShaderString:WZkGPUImageColorSwizzlingFragmentShaderString];
        }
